...
### Release v0.8.1 Brief:
  *  This patch update extends support to DSP configurations with the Recip/RSQRT QLI option disabled, ensuring clean compilation and correct execution on such cores.
